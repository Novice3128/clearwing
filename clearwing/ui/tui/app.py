...
class ClearwingApp(App):
    ...
    def _handle_cost_update(self, data):
        ...
        if isinstance(data, dict):
            ...
            # Legacy emitters (emit_cost) carry a cumulative `tokens` value
            # instead — adopt it directly when the per-call fields are absent.
            ...
            elif isinstance(data.get("tokens"), int):
                self._cost_tokens_total = data["tokens"]
